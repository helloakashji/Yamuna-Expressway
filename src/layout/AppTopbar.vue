...
const hideTopbar = computed(() => {
    return router.currentRoute.value.name === 'mainuserlogin';
});
</script>

<template>
    <div class="layout-topbar" :class="{ 'hidden': hideTopbar }">
        <router-link to="/" class="layout-topbar-logo">
            <img src="../assets/img/pages/yamuna_auth_logo.png" alt="logo" />
            <!-- <span>SAKAI</span> -->
        </router-link>
